...
#
# Preset downloader for Tone 3000
#
...
class PresetsT3kHandler(ZynthianBasicHandler):
...
class CallbackHandler(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if canceled:
            print("Benutzer hat den Flow abgebrochen.")
        ...
        try:
            ...
            # Wenn alle 0 und IR-Tone 0 setze tone_name = "IR"
        ...
        try:
            ...
            if not isinstance(models, list):
                print(
                    "Warnung: 'data' ist keine Liste. Versuche als Liste zu behandeln..."
                )
                models = models
        ...
        for model in models:
            ...
            if not model_url:
                print("Kein model_url für Modell, überspringe...")
                continue
