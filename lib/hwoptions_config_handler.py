...
class HWOptionsConfigHandler(ZynthianConfigHandler):
    ...
    @tornado.web.authenticated
    def post(self):
        self.request.arguments['ZYNTHIAN_LIMIT_USB_SPEED'] = self.request.arguments.get(
            'ZYNTHIAN_LIMIT_USB_SPEED', '0')
        self.request.arguments['ZYNTHIAN_DISABLE_OTG'] = self.request.arguments.get(
            'ZYNTHIAN_DISABLE_OTG', '0')
        self.request.arguments['ZYNTHIAN_OVERCLOCKING'] = self.request.arguments.get(
            'ZYNTHIAN_OVERCLOCKING', '0')
