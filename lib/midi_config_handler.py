...
class MidiConfigHandler(ZynthianConfigHandler):
    ...
    def post(self):
        ...
        self.request.arguments['ZYNTHIAN_MIDI_CC_AUTOMODE'] = self.request.arguments.get(
            'ZYNTHIAN_MIDI_CC_AUTOMODE', '0')
        ...
        self.request.arguments['ZYNTHIAN_MIDI_SINGLE_ACTIVE_CHANNEL'] = self.request.arguments.get(
        ...
        self.request.arguments['ZYNTHIAN_MIDI_RTPMIDI_ENABLED'] = self.request.arguments.get(
            'ZYNTHIAN_MIDI_RTPMIDI_ENABLED', '0')
        self.request.arguments['ZYNTHIAN_MIDI_NETWORK_ENABLED'] = self.request.arguments.get(
            'ZYNTHIAN_MIDI_NETWORK_ENABLED', '0')
        self.request.arguments['ZYNTHIAN_MIDI_TOUCHOSC_ENABLED'] = self.request.arguments.get(
            'ZYNTHIAN_MIDI_TOUCHOSC_ENABLED', '0')
        self.request.arguments['ZYNTHIAN_MIDI_AUBIONOTES_ENABLED'] = self.request.arguments.get(
    ...
    def load_midi_profiles(self):
        ...
        for midi_profile_script in invalidFiles:
            logging.warning(
                "Invalid profile will be ignored: " + midi_profile_script)
