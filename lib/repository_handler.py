...
class RepositoryHandler(ZynthianConfigHandler):
    ...
    def get_config_info(self):
        ...
        for repitem in self.repository_list:
            ...
            testing_overall |= (
                self.get_repo_current_branch(repitem[0]) != 'stable')
    ...
    def set_repo_tag(self, repo_name, tag_name):
        ...
        if tag_name != current_branch:
            ...
            if tag_name == 'master':
                ...
                check_output("cd {}; git checkout .; git branch -d {}; git checkout tags/{} -b {}".format(
                    repo_dir, tag_name, tag_name, tag_name), shell=True)
            return True
